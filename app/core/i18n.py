...
_EN = {
    ...
    "引擎管理": "Engine Manager",
    "导出CSV": "Export CSV",
    "生成 data.yaml": "Generate data.yaml",
    ...
    "选择 data.yaml 保存位置": "Choose data.yaml output location",
    "输入 YOLO 类别": "Enter YOLO classes",
    "请输入类别名称，使用英文逗号分隔": "Enter class names separated by commas",
    "至少需要一个检测类别": "At least one detection class is required",
    "训练集比例（0.1 - 0.99）": "Training split ratio (0.1 - 0.99)",
    "选择 YOLO 数据集输出目录": "Choose YOLO dataset output directory",
    "输出目录必须为空，以避免覆盖已有数据集": "The output directory must be empty to avoid overwriting an existing dataset",
    ...
    "已导出 {0}": "Exported {0}",
    "生成 data.yaml 失败：{0}": "Failed to generate data.yaml: {0}",
    "划分数据集失败：{0}": "Failed to split dataset: {0}",
    "已生成 data.yaml：\n{0}\n类别数：{1}": "data.yaml generated:\n{0}\nClasses: {1}",
    "YOLO 数据集划分完成：\n{0}\n训练集：{1} 张\n验证集：{2} 张\n类别数：{3}\n请再点击“生成 data.yaml”。": "YOLO dataset split complete:\n{0}\nTrain images: {1}\nValidation images: {2}\nClasses: {3}\nClick Generate data.yaml next.",
